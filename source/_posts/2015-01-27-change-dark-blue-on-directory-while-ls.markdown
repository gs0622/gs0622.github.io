---
layout: post
title: "Change dark blue on directory while ls"
date: 2015-01-27 09:11:48 +0800
comments: true
categories: linux
---
...
For some reason it is not a big issue in local terminal.
However it happens in remote login through ssh and then do 'ls' command.

<!--more-->

A simple way to fix this to change $LS_COLOR environment variable.
Find the 'di', then either change it or append at end to override it.
...
In my case, I override 'di' color from dark blue (34) to sky blue (36).
